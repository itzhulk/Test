 ...
 * @author Muiz
 */
public class CompanyLoginWindow2 extends javax.swing.JFrame {

    
    private String companyID;      //user id
    ...
    private void initComponents() {
        ...
        setTitle("Login to your authority account");
        ...
        jLabel2.setText("Authority Account");
...
String url = "jdbc:mysql://localhost:3306/citybusmgnt?zeroDateTimeBehavior=CONVERT_TO_NULL";
	...
	//JOptionPane.showMessageDialog(null, "Connected to DataBase");
				...
				while(rs.next())
				{				
if(rs.getString(5).equals(Password)&&rs.getString(4).equals(UserName))		{
JOptionPane.showMessageDialog(null, "Login Success" + ""
								+ "\n" + "User Name " + UserName + "\nName : " + rs.getString(2));					
	companyID = rs.getString(1);
    BusName = rs.getString(2);					
     super.dispose();
     AuthorityWindow3 sd = new AuthorityWindow3(UserName, BusName, companyID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompanyLoginWindow2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CompanyLoginWindow2().setVisible(true);
            }
        });
    }
