 ...
 * @author Muiz
 */
public class UserLoginWindow2 extends javax.swing.JFrame {
     ...
     public void getConnection()
	{
		...
		try
		{
			...
			{
                                super.dispose();
                            	srcDesDecide2 sd = new srcDesDecide2(UserName,Password);
                                sd.setVisible(true);
			}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserLoginWindow2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new UserLoginWindow2().setVisible(true);
            }
        });
    }
